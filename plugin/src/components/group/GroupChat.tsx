...
export default forwardRef<HTMLDivElement, {}>(function GroupChat(props, ref) {
  const [{ messages, events, error, fetching, sending }, { fetchMoreMessages, sendMessage }] = useGroupChat()
  ...
  const [{ height: msgInputHeight } = { height: 0 }, chatInput] = useMeasure<HTMLTextAreaElement>()
  ...
  return (
    <div ref={ref} className="px-6 pb-4 h-full w-full relative">
      <div
        ref={container}
